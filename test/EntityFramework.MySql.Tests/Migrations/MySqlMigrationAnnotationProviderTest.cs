...
{
    public class MySqlMigrationAnnotationProviderTest
    {
        private readonly ModelBuilder _modelBuilder;
        private readonly MySqlMigrationsAnnotationProvider _provider;

        private readonly Annotation _autoincrement = new Annotation(MySqlAnnotationNames.Prefix + MySqlAnnotationNames.Autoincrement, true);

        public MySqlMigrationAnnotationProviderTest()
        {
            _modelBuilder = new ModelBuilder(new CoreConventionSetBuilder().CreateConventionSet(), new Model());
            _provider = new MySqlMigrationsAnnotationProvider();
        }
