...
{
    public class MySqlMigrationSqlGeneratorTest : MigrationSqlGeneratorTestBase
    {
    ...
    ""Event"" TEXT NOT NULL DEFAULT '2015-04-12 17:05:00'
        ...
        public void CreateTableOperation_with_annotations(bool autoincrement, string pkName)
        {
            ...
            if (autoincrement)
            {
                addIdColumn.AddAnnotation(MySqlAnnotationNames.Prefix + MySqlAnnotationNames.Autoincrement, true);
            }
        ...
        public void CreateSchemaOperation_not_supported()
        {
            ...
            Assert.Equal(MySqlStrings.SchemasNotSupported, ex.Message);
        }
        ...
        public void RestartSequenceOperation_not_supported()
        {
            ...
            Assert.Equal(MySqlStrings.SequencesNotSupported, ex.Message);
        }
        ...
        public override void AddForeignKeyOperation_with_name()
        {
            ...
            Assert.Equal(MySqlStrings.InvalidMigrationOperation, ex.Message);
        }
