...
{
    public class IncludeMySqlTest : IncludeTestBase<NorthwindQueryMySqlFixture>
    {
        public IncludeMySqlTest(NorthwindQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
