...
{
    public class OptimisticConcurrencyMySqlTest : OptimisticConcurrencyTestBase<MySqlTestStore, F1MySqlFixture>
    {
        ...
        // Override failing tests because MySql does not allow store-generated row versions.
        // Row version behavior could be imitated on MySql. See Issue #2195
        // TODO move these tests into the testing just for SqlServer since they don't apply to MySql
