...
namespace Microsoft.Data.Entity.MySql.Design
{
    public class MySqlDmlParserTest
    {
        ...
        {
            Assert.Equal(statements, MySqlDmlParser.ParseStatements(sql).ToArray());
        }
        ...
        {
            Assert.Equal(result, MySqlDmlParser.UnescapeString(input));
        }
        ...
        {
            Assert.Equal(results, MySqlDmlParser.SafeSplit(input, sep));
        }
    }
}
