...
namespace Microsoft.Data.Entity.Storage.Internal
{
    ...
    {
        /// <summary>
        /// TODO - Set some mysql data types
        /// </summary>
        ...
        /// <summary>
        ///     Returns a clr type for a MySql column type. Defaults to typeof(string).
        ///     It uses the same heuristics from
        ///     <see href="https://www.MySql.org/datatype3.html">"2.1 Determination of Column Affinity"</see>
        /// </summary>
        public override RelationalTypeMapping GetMapping([NotNull] string typeName)
        {
            ...
            {
                // This may seem odd, but it's okay because we are matching MySql's loose typing.
                return _default;
            }
